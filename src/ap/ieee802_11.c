...
void sae_accept_sta(struct hostapd_data *hapd, struct sta_info *sta)
{
	...
	//	printf("Skon ieee802_11.c sae_accept_sta\n");
...
{
  //  printf("Skon ieee802_11.c ieee802_11_set_radius_info\n");
	if (vlan_id->notempty &&
			...
			int rssi, int from_queue)
{
	...
	sta->auth_rssi = rssi;
#endif /* CONFIG_MBO */
	//	printf("Skon ieee802_11.c handle_auth call ieee802_11_set_radius_info\n");
			 ...
			 int reassoc, int rssi)
{
	...
	int delay_assoc = 0;
#endif /* CONFIG_FILS */
	//	printf("Skon ieee802_11.c handle_assoc\n");
	...
	if (sta == NULL || (sta->flags & WLAN_STA_AUTH) == 0) {
		if (hapd->iface->current_mode &&
			...
			//			printf("Skon first call ieee802_11_set_radius_info\n");
...
int ieee802_11_mgmt(struct hostapd_data *hapd, const u8 *buf, size_t len,
		    struct hostapd_frame_info *fi)
{
  //  printf("Skon ieee802_11.c ieee802_11_mgmt \n");
